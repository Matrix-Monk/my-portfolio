    ...
    return (
      <>
        ...
        <nav className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">
          ...
          <ul className="hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 bg-white shrink-sm bg-opacity-50">
            <li>
          ...
          >
            <div className="abolute right-6 top-6 " onClick={closeMenu}>
              <Image
